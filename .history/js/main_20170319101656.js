$(document).ready(function () {
    ...
    $.getJSON(url).done(function (reponse) {
        ...
        for (let item of reponse) {
            ...
            html = `<div class="col-sm-6 col-md-4" class="item">
                <div class="thumbnail">
                    <div class="img-box">
                    ...
                    <p class="item-actions"><a data-id="${item.id}" class="btn btn-danger remove" role="button">Supprimer</a>
            ...
            $('.btn-danger').click(function () {
                ...
                // je recupere l'id
                let id = $(this).attr('data-id'); // je crée un attribut "data-id" sur mon boutton"
                console.log(id);
