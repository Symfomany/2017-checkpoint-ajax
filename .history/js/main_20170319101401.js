$(document).ready(function () {
    ...
    $.getJSON(url).done(function (reponse) {
        ...
        for (let item of reponse) {
            ...
            html = `<div class="col-sm-6 col-md-4" class="item" data-id="${item.id}">
                <div class="thumbnail">
                    <div class="img-box">
                    ...
                    <p class="item-actions"><a class="btn btn-danger remove" role="button">Supprimer</a>
            ...
            /**
             * La partie DELETE sera en bonus (trop dur...)
             */
            $('.remove').click(function () {

                let id = $(this).parents('.col-md-6').attr('data-id');
                console.log($(this).parents('.col-md-6'));

                // Nouveauté : envoyer une requete en DELETE
                ...
                $.ajax({
                    ...
                    success: function (result) {
                        $('.btn-danger').parents('.col-md-4').fadeOut();
                    }
                });
