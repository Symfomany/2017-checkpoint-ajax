$(document).ready(function () {
    ...
    /**
     * Chargement des données du serveur en JSON
     */
    $.getJSON(url).done(function (reponse) {
        ...
        for (let item of reponse) {
            ...
            $('#articlesBody .btn-danger').click(function () {
                ...
                /*
                * Nouvelle fonction $/ajax plus général pour faire n'import quel requete AJAX: GET, POST,  * DELETE...
                * url: url de la requete AJAX
                * type: quel type est la requete AJAX: GET, POST, DELETE...
                */
                $.ajax({
                    url: url + '/' + id,
                    type: 'DELETE' // Type: GET, POST, DELETE...
                }).done(function (reponse) { //quand c'est fini
    ...
    // Quand je clique sur le bouton de validation de formulaire
